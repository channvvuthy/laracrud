...
<div class="card mt-3">
    <div class="card-header">
        <h4>
            @if (isset($data['add_title']))
                {{ __('common.' . $data['add_title']) }}
            @else
                ...
                <div class="row">
                    ...
                    <div class="col-{{ $data['grid'] }}">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="{{ $form['type'] }}" class="form-control" id="{{ $form['field'] }}" name="{{ $form['field'] }}" @if (isset($form['required']) && $form['required']) required @endif>
                            </div>
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="3" style="resize: none;" id="{{ $form['field'] }}" name="{{ $form['field'] }}" @if (isset($form['required']) && $form['required']) required @endif></textarea>
                            </div>
                            ...
                            <label for="{{ $form['field'] }}" class="col-sm-2 col-form-label">{{ __('common.' . $form['title']) }}</label>
                            <div class="col-sm-10">
                                <select class="form-control" name="{{ $form['field'] }}" @if (isset($form['required']) && $form['required']) required @endif>
                            ...
                            <label for="{{ $form['field'] }}" class="col-sm-2 col-form-label">{{ __('common.' . $form['title']) }}</label>
                            <div class="col-sm-10">
                                <select class="form-control select2" name="{{ $form['field']}}" style="width: 100%;" @if (isset($form['required']) && $form['required']) required @endif>
                                    <option selected>{{ __('common.Please select') }}
                                        {{ __('common.' . $form['title']) }}
                                    </option>
                                    @foreach ($data[$form['field']] as $select)
                            ...
                            <div class="col-sm-10">
                                <input type="{{ $form['type'] }}" class="form-control" style="padding-top:3px;" id="{{ $form['field'] }}" name="{{ $form['field'] }}[]" @if (isset($form['accept'])) accept="{{ $form['accept'] }}" @endif multiple @if (isset($form['required']) && $form['required']) required @endif>
                            </div>
                            @else
                            <label for="{{ $form['field'] }}" class="col-sm-2 col-form-label">{{ __('common.' . $form['title']) }}
                                @if (isset($form['required']) && $form['required'])
                                <span class="text-danger">*</span>
                                @endif
                            </label>
                            <div class="col-sm-10">
                                <input type="{{ $form['type'] }}" class="form-control" style="padding-top:3px;" id="{{ $form['field'] }}" name="{{ $form['field'] }}" @if (isset($form['accept'])) accept="{{ $form['accept'] }}" @endif @if (isset($form['required']) && $form['required']) required @endif>
                            </div>
                            @endif
                            @endif
                        </div>
