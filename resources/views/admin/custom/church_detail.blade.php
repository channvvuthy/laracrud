            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <div class="d-flex flex-row align-items-center">
                        ...
                        <a href="#" class="files">
                            <i class="fa fa-image text-gray" data-url="{{ is_array($data['find']) ? $data['find'][$detail['field']] : $data['find']->{$detail['field']} }}" data-type="multiple_file"></i>
                        </a>
                        @else
                        <a href="#" class="files">
                            <i class="fa fa-image text-gray" data-url="{{ is_array($data['find']) ? $data['find'][$detail['field']] : $data['find']->{$detail['field']} }}" data-type="single_file"></i>
                        </a>
                        @endif
                        @else
                ...
                <li class="list-group-item">
                    <div class="d-flex flex-row align-items-center">
                        <b class="mr-2" style="white-space: nowrap;">{{ __('common.Time & Session') }} </b>
                        @if(isset($data['find']['timetables']))
                        <table class="table">
                            <thead class="thead-dark">
                                <tr>
                                    <th>{{ __('common.Time') }}</th>
                                    <th>{{ __('common.Session') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="files">
                                        <i class="fa fa-image text-gray" data-url="{{ $value->image }}" data-type="single_file"></i>
                                    </a>
                                </td>
                            </tr>
                            @endforeach
