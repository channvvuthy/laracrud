...
@section('content')
    ...
    <div class="card mt-3">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ Helper::indexUrl() }}update">
            ...
            <input type="hidden" name="id" value="{{ $data['find']->id }}" id="church_id">
            <div class="px-3 pt-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row mb-3 timetable">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" name="sessions[]" required
                                                    value="{{ $value->session }}">
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="file" class="form-control" name="images[]"
                                                    style="padding-top:3px;" accept="image/*">
                                            </div>
                                            @if ($key != 0)
                                                <div class="col-sm-2 d-flex align-items-center btn-minus">
                                                    <div class="bg-danger p-1 rounded-circle d-flex justify-content-center align-items-center"
                                                        style="cursor:pointer; width:28px; height: 28px;">
                                                        <a href="#" class="btn-delete"
                                                            data-id="{{ $key }}">
                                                            <i class="fa fa-minus" data-id="{{ $key }}"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            @else
                                                <div class="col-sm-2 d-flex align-items-center btn-plus">
                                                    <div class="bg-success p-1 rounded-circle d-flex justify-content-center align-items-center"
                                                        style="cursor:pointer; width:28px; height: 28px;">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".btn-delete").on("click", function(e) {
                ...
                deleteId = $("#church_id").val();
            });

            $(".btn-delete-item").on("click", function() {
                window.location.href = "/admin/churchservice/" + `${deleteId}/delete/${index}`;
            });
