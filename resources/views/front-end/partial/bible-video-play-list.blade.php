  @if (isset($libraries) && $libraries->count())
      @foreach ($libraries as $key => $library)
          <li class="text-white border-b @if ($key == 0) pb-3 @else py-3 @endif">
              <a href="{{ route('bible-studies') }}?type=bible-video&detail={{ $bibleStudy->id }}&index={{ $key }}"
                  ...
                  <div class="row">
                      <div class="col-sm-4">
                          <div class="position-relative">
                              ...
                              <div
                                  class="position-absolute top-0 start-0 w-100 h-100 bg-overlay d-flex justify-content-center align-items-center">
                              ...
                              <div
                                  class="position-absolute top-0 start-0 w-100 h-100 d-flex justify-content-start align-items-center">
