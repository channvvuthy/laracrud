            ...
            @if ($bibleStudies && $bibleStudies->count())
                ...
                <div class="row">
                    @foreach ($bibleStudies as $bibleStudy)
                        <div class="col-md-3 col-sm-6 mb-5 col-12 col">
                            <a href="bible-studies?type=bible-video&detail={{ $bibleStudy->id }}" class="text-decoration-none"
                                style="color: black;">
                                <div class="box rounded-lg shadow-bottom">
                                    <div>
                                        <img src="{{ $bibleStudy->photo }}" class="rounded-top-base img-fluid"
                                            id="main_image" data-url="{{ $bibleStudy->photo }}" />
                                    </div>
