            ...
            @if ($bibleStudies && $bibleStudies->count())
                ...
                <div class="row">
                    @foreach ($bibleStudies as $bibleStudy)
                        <div class="col-sm-3">
                            <a href="bible-studies?type=bible-audio&detail={{ $bibleStudy->id }}" class="text-decoration-none"
                                style="color: black;">
                ...
                <div class="d-flex justify-content-end clearfix">
                    @if (request()->get('page_size') != null)
                        @php
                            ...
                            $viewMore = $pageSize + 4;
                        @endphp
                        <a href="/bible-studies?type=bible-audio&page_size={{ $viewMore }}"
                            class="text-white text-decoration-none">View
                            More -></a>
                    @else
                        <a href="/bible-studies?type=bible-audio&page_size=4" class="text-white text-decoration-none">View
                            More -></a>
                    @endif
